  ...
  return (
    <section id="api" className="mx-auto max-w-6xl px-6 py-24 sm:py-28">
      ...
      <Reveal className="mt-10" delay={0.05}>
        <div className="mb-5 inline-flex items-center gap-2.5 rounded-lg border border-ink-900/10 bg-white/80 px-3.5 py-2 font-mono text-[13px] shadow-sm">
          <span className="rounded-md bg-emerald-100 px-2 py-0.5 text-[11px] font-bold uppercase tracking-wide text-emerald-700">
            POST
          </span>
          <span className="text-ink-800">/api/chat</span>
        </div>

        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div>
            <p className="mb-3 text-[13px] font-semibold uppercase tracking-wider text-ink-500">
              Request
            </p>
